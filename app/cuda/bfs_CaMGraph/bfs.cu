...
void BFSGraph( int argc, char** argv) 
{
	...
	fprintf(stdout, "The start of the address for hot vertices %p, The end of the address for all vertices is %p\n", d_graph_nodes, d_graph_nodes+sizeof(Node)*no_of_nodes);
